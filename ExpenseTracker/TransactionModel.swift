...
extension Category {
    ...
    static let financeCharges = Category(id: 402, name: "Finanace Charges", icon: .hand_holding_usd, mainCategoryId: 4)
    ...
    static let creditCardPayment = Category(id: 901, name: "Credit Card Payment", icon: .hand_holding_usd, mainCategoryId: 9)
}
extension Category {
